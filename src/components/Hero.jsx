    ...
    return (
        <section id="hero" className="min-h-screen flex items-center justify-center pt-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 w-full">
                    ...
                    >
                        <div className="inline-flex items-center space-x-2 bg-slate-100/10 backdrop-blur-sm dark:bg-dark-card/30 px-3 py-1 rounded-full text-sm font-medium mb-6 border border-slate-200/20 dark:border-slate-800/50">
                            <Terminal size={16} className="text-primary-blue" />
                            <span className="text-white">Tech Enthusiast | Web Developer</span>
                        </div>

                        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 text-white drop-shadow-md">
                            Hi, I'm <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-primary-purple drop-shadow-sm">
                                Daraniedaran
                            </span>
                        </h1>

                        <p className="text-xl text-slate-200 dark:text-slate-300 mb-8 max-w-2xl mx-auto md:mx-0 drop-shadow-sm">
                ...
                >
                    <span className="text-sm text-slate-300 mb-2 drop-shadow-sm">Scroll Down</span>
                    <motion.div
                        animate={{ y: [0, 10, 0] }}
                        transition={{ repeat: Infinity, duration: 2 }}
                    >
                        <ArrowDown size={20} className="text-slate-300 drop-shadow-sm" />
                    </motion.div>
                </motion.div>
        </section>
    );
